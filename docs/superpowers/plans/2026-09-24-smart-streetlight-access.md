...
- [x] **Step 1: Add the Spring Security dependency.**
...
- [x] **Step 3: Add server-only authentication properties.**
...
- [x] **Step 4: Add session security configuration.**
...
- [x] **Step 5: Add authentication endpoints.**
...
- [x] **Step 6: Run the backend tests and package.**
...
- [x] **Step 1: Add API auth types and requests.**
...
- [x] **Step 2: Add path-based mode resolution.**
...
- [x] **Step 3: Add the channel chooser and admin login UI.**
...
- [x] **Step 4: Gate the dashboard UI by role.**
...
- [x] **Step 5: Run frontend type checking and production build.**
...
- [x] **Step 1: Verify guest and admin API behavior locally.**
...
- [x] **Step 4: Commit source changes and document deployment.**
